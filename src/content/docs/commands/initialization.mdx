...
5.  **Deployment Strategy**: Choose your preferred [Deployment Mode](/guides/deployment-modes). You can also set up multiple [Deployment Environments](/guides/deployment-environments) later.
