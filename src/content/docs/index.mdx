...
hero:
    ...
    html: |
        <div class="hero-terminal">
          <div class="hero-terminal-header">
            ...
            <div class="hero-terminal-title">graft — bash</div>
          </div>
          <div class="hero-terminal-body">
            <pre class="hero-ascii">
        <span>_██████___██████____█████___███████_████████ </span>
        <span>██________██___██__██___██__██_________██    </span>
        <span>██___███__██████___███████__█████______██    </span>
        <span>██____██__██___██__██___██__██_________██    </span>
        <span>_██████___██___██__██___██__██_________██    </span>
            </pre>
            <div class="hero-cursor-line">
              <span class="hero-prompt">$</span>
              <span class="hero-command-text"></span>
  ...
  actions:
    ...
    - text: Command Reference
      ...
      icon: open-book
      variant: minimal
    - text: Graft Hook Docs
      link: /graft-hook/introduction/
      icon: rocket
      variant: minimal
---
